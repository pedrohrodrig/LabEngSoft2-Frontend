...
import "./personaltrainpage.css";

function PersonalTrainPage() {
  ...
  const createEndpoint = `${paths.back}/training/create/`;

  useEffect(() => {
    axios.get(`${paths.back}/training/list/`)
    .then((response) => {
  ...
  const handleFileDelete = (id) => {
    axios.delete(`${paths.back}/training/${id}`)
    .then((response) => {
          ...
          <form onSubmit={handleSubmit}>
            <div className="grid">
              <div className="col">
                ...
                />
                <button className="diet-button" type="submit">Upload</button>
              </div>
              <div className="col">
...
export default PersonalTrainPage;
